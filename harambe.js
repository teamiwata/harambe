...
var states = [{enter: enterMenu, update: updateMenu, exit: exitMenu}, 	// Main menu state.
			...
			{enter: enterOver, update: updateOver, exit: exitOver}];	// GameOver state.
...
var buttons = [{img:"../img/menu/btnStart.png", imgO:"../img/menu/btnStartO.png", x:400, y:720, w:128, h:32, over:false, click:onStartClick}, // Start button
	...
	{img:"../img/menu/btnStart.png", imgO:"../img/menu/btnStartO.png", x:0, y:750, w:128, h:32, over:false, click:onOverStartClick},
	{img:"../img/menu/btnExit.png", imgO:"../img/menu/btnExitO.png", x:520, y:750, w:128, h:32, over:false, click:onExitOverClick},] // Start button]; 
...
gameOver.src = "../img/menu/gameoverharambe.png";
var activeBtns = [];
...
function enterOver()
{
	...
	surface.clearRect(0,0,canvas.width,canvas.height);
    activeBtns = [ buttons[8],buttons[9]];	
}
...
function updateOver()
{
	...
	surface.clearRect(0,0,canvas.width,canvas.height);
    checkButtons();
    surface.drawImage(gameOver, 0, 0);
    renderButtons();
}
...
function onOverStartClick(){
	changeState(1)
}

function onExitOverClick()
{
        changeState(0);
		document.getElementById("Scoreboard").style.display = "none";
}
...
var HarambeDead = false;
function HarambeDeath()
{
	HarambeDeath=true;
	
	if (HarambeDeath==true)
	{
		changeState(3);
		HarambeDeath=false;
	}
